...
/** Full JDP case study body (from “My role” through Other projects). Tabpanel wrapper lives on the page. */
export function CaseStudyFull() {
  return (
    <>
      ...
      <div
        id="section 2"
        className="responsive-section-y-case-study bg-brand-greys-20  flex justify-center items-center w-full"
      >
        <div className="flex  flex-col justify-between items-center space-y-4 ">
          ...
          <div className="flex  flex-col justify-between items-center ">
            <MainTextBlock
              ...
              description={
                "JDP was an underperforming page, there were some data signals and internal feedback pointing to the following:"
              }
            ...
            <div className="flex  flex-col justify-between items-center space-y-10 responsive-width-case-study  ">
              <div className="flex  flex-col justify-between items-center space-y-3 gap-2  ">
                ...
                <NumberedItem
                  ...
                  description="The page was built on top of legacy technology, which made it slow, a poor experience for job seekers and harder for engineers to work on."
                />
                <NumberedItem
                  number={3}
                  title="No page differentiation for free and paying clients:"
                  description="There was no differentiation between our provisional (free) and paying clients' JDPs, which would give the sales team additional leverage for upselling."
                />
                <NumberedItem
                  number={4}
                  title="Missed opportunity to capture job seekers' info in our email ecosystem:"
      ...
      <div
        id="section 3"
        className="responsive-section-y-case-study bg-[#fff]  flex  lg:flex-col flex-col justify-center items-center w-full"
      >
        <div
              ...
              <MainTextBlock
                ...
                description={
                  <>
                    ...
                    <br />
                    <br />
                    Given everything we knew at this point, with the product
      ...
      <div
        id="section 4"
        className="responsive-section-y-case-study bg-[#CFDCE5]  flex  lg:flex-col flex-col justify-center items-center w-full"
      >
        <div
          className=" responsive-width-case-study flex  flex-col space-y-4 justify-between mt-10
          "
            ...
            <div className="w-full">
              <MainTextBlock
                ...
                description={
                  <>
                    ...
                    to get a general picture of direct and indirect competitors
              ...
              <div className="flex justify-between flex-col gap-4">
                ...
                <NumberedItem
                  title=""
                  number={3}
                  description="Highlight company details such as culture, benefits, employee reviews/testimonials to aid job seekers' decisions (Competitive Analysis)"
                />
              </div>
            </div>
            <img
      ...
      <div
        id="section 5 "
        className="responsive-section-y-case-study bg-white  flex justify-center items-center w-full"
      >
        <div className="flex  flex-col justify-between items-center space-y-4 ">
          ...
          <div className="flex  flex-col justify-between items-center ">
            <MainTextBlock
              ...
              description={
                "I then started by working on a few design explorations based on our initial requirements and specifications of the project, while keeping in mind all our insights and feedback collected."
              }
              className=" responsive-width-case-study"
            />
        ...
        <div className="flex  flex-col justify-between items-center space-y-4 ">
          <div className="flex  flex-col justify-between items-center ">
            <MainTextBlock
              ...
              description={
                "After reviewing the initial design exploration with all stakeholders, we narrowed it to the MVP that we set out to launch.  It was a stripped down version of the fully featured version, this was done strategically so that we can measure the impact of each newly added feature."
              }
              className=" responsive-width-case-study"
            />
            <div className="flex  flex-col justify-between items-center space-y-10 ">
        ...
        <div className="flex  flex-col justify-between items-center space-y-4 ">
          <div className="flex  flex-col justify-between items-center ">
            <MainTextBlock
              ...
              description={
                <>
                  One hypothesis we had was that the CTA was not giving users
                  enough context. We took the opportunity of the first launch to
                  test a few copy variations.
                  <br />
                  <br />
      ...
      <div
        id="section 8 "
        className="responsive-section-y-case-study bg-[#56CCF2]  flex justify-center items-center w-full"
      >
        <div className="flex  flex-col justify-between items-center space-y-4 ">
          <Subtitle label="Research" />
          <div className="flex  flex-col justify-between items-center ">
            <MainTextBlock
              title={"We Step Back to Rethink the Broader Experience"}
              description={
                "Even though we knew from the very beginning the technical constraints of the project, we still wanted to approach the design exploration with an open mind and design for what we believed was the ideal experience based on a few hypotheses, validate them, and then from there narrow it down to what was viable and feasible given our resources. After a few rounds of design exploration, I designed three design concepts to test. "
              }
              className=" responsive-width-case-study"
            />
            <div className="flex  flex-col justify-between items-center space-y-10 ">
          ...
          <div className=" responsive-width-case-study flex  md:flex-col flex-col justify-between pt-8 space-x-8 md:space-y-0 space-y-8 ">
            ...
            <ul className="list-disc list-outside   space-y-0">
              <li className="text-left">
                <p>
                  Collect insights on how job seekers search for jobs, what they
                  care about, and what is of most value for them when learning
                  about jobs and companies
                </p>
              </li>
              <li className="text-left">
                <p>
                  Propose a set of information that we believe will differentiate
                  our job pages if we were to collect that information from
                  companies
                </p>
              </li>
            </ul>
          ...
          <div className=" responsive-width-case-study flex  md:flex-col flex-col justify-between pt-8 gap-3 md:space-y-0 space-y-8 ">
            ...
            <p>
              After conducting <strong>8 user interviews</strong>, I got to
              analyze and synthesize all interviews. The main takeaways were:
            </p>
            <ul className="list-disc pl-6 bg-white p-4 rounded-lg space-y-1">
              ...
              <li className="text-left">
                <span className="align-top">
                  ...
                  company’s values and mission is a major motivator in deciding
                  where to apply (or not).
                </span>
              </li>
              <li className="text-left">
                <span className="align-top">
                  <strong>Trust Issues:</strong> Job seekers express high levels
                  of distrust in Glassdoor reviews and wish there were more
                  reliable sources.
                </span>
              </li>
              <li className="text-left">
          ...
          <div className=" responsive-width-case-study flex  md:flex-col flex-col justify-between pt-8 gap-3 md:space-y-0 space-y-8 ">
            ...
            <p>
              ...
              upper management, we decided it was going to be a huge undertaking
              to create company culture characteristics at that moment, but this
              provided us with other insights and helped us make better use of
              our existing company information that was relevant to job seekers
              at this point of their job search.
            </p>
          </div>
        </div>
      </div>
            ...
            <MainTextBlock
              ...
              description={
                <>
                  ...
                  <strong>
                    job seekers struggle to find clear benefit and compensation
                    info in one place. The Muse brings that data front and center
                    on job pages, saving time and building trust.
                  </strong>{" "}
                  <br />
                  <br />
                  For employers, it’s a chance to highlight unique perks and
                  attract value-aligned candidates. This focus gives The Muse a
                  clear edge over other boards that hide or overlook benefits.
                </>
              }
              className=" responsive-width-case-study"
            />
          ...
          <div className="flex  flex-col justify-between items-center ">
            <MainTextBlock
              ...
              description={
                <>
                  <strong>
                    User research revealed job seekers wanted to hear directly
                    from employees
                  </strong>
                  , but our library of company videos was underused. Although
                  video generated a third of revenue, many received very few
                  views. This low engagement made it harder to upsell and retain
                  clients.
                  <strong>
                    As a result, we brought employee testimonials directly into
                    the JDP to boost visibility and impact.
                  </strong>
                </>
              }
              className=" responsive-width-case-study"
            ...
            <MainTextBlock
              ...
              description={
                <>
                  ...
                  job-alert sign-up experience for job seekers on JDP that led to
                  higher job engagement and more applications.
                </>
              }
              className=" responsive-width-case-study"
            />
        ...
        <div className="flex  flex-col justify-between items-center space-y-4 ">
          <div className="flex  flex-col justify-between items-center ">
            <MainTextBlock
              ...
              description={
                <>
                  We introduced Quick Apply to increase our job applies, keep us
                  competitive in the market and increase job seeker retention and
          ...
          <div className="flex  flex-col justify-between items-center ">
            ...
            <ol className="custom-counter space-y-4 responsive-width-case-study">
              <li className="custom-li text-left">
                <p>
                  I helped conduct several user tests and research which helped
                  us get a better understanding of what job seekers value most
                  when looking for jobs and gave us more confidence in what we
                  built.
                </p>
              </li>
              <li className="custom-li text-left">
                <>
                  ...
                  <strong>
                    we saw a 40% YoY growth and 110% growth vs the previous year.
                  </strong>
                </>
              </li>
              <li className="custom-li text-left">
                <p>
                  We had a JDP that was much faster to build on and optimized for
              ...
              <li className="custom-li text-left">
                <p>
                  By introducing Job Alerts and Quick Apply, we could now engage
                  users better to continue providing them with more value long
                  after they come to The Muse.{" "}
                  <strong>
                    For Job Apply, we saw 2x increase in applications per
                    applicant.
                  </strong>
                </p>
              </li>
