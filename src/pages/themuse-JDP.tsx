                ...
                <MainTextBlock
                  ...
                  description={
                    <>
                      ...
                      to get a general picture of direct and indirect
              ...
              <MainTextBlock
                ...
                description={
                  <>
                    ...
                    enough context. We took the opportunity of the first launch
                    to test a few copy variations.
                    <br />
                    <br />
          ...
          <div className="flex  flex-col justify-between items-center space-y-4 ">
            ...
            <div className=" responsive-width-case-study flex  md:flex-col flex-col justify-between pt-8 gap-3 md:space-y-0 space-y-8 ">
              ...
              <p>
                ...
                moment, but this provided us with other insights and helped us
                make better use of our existing company information that was
                relevant to job seekers at this point of their job search.
              </p>
            </div>
          </div>
        </div>
              ...
              <MainTextBlock
                ...
                description={
                  <>
                    ...
                    <strong>
                      job seekers struggle to find clear benefit and
                      compensation info in one place. The Muse brings that data
                      front and center on job pages, saving time and building
                      trust.
                    </strong>{" "}
                    <br />
                    <br />
                ...
                description={
                  <>
                    ...
                    <strong>
                      ...
                      into the JDP to boost visibility and impact.
                    </strong>
                  </>
                }
                className=" responsive-width-case-study"
          ...
          <div className="flex  flex-col justify-between items-center space-y-4 ">
            <div className="flex  flex-col justify-between items-center ">
              <MainTextBlock
                ...
                description={
                  <>
                    We introduced Quick Apply to increase our job applies, keep
              ...
              <ol className="custom-counter space-y-4 responsive-width-case-study">
                <li className="custom-li text-left">
                  <p>
                    ...
                    helped us get a better understanding of what job seekers
                    value most when looking for jobs and gave us more confidence
                    in what we built.
                  </p>
                </li>
                <li className="custom-li text-left">
